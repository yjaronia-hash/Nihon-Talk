                ...
                {[
                  {
                    ...
                    content: "히라가나도 모르고 시작해서 걱정이 가득했는데 벌써 일상 대화가 가능해져서 제 자신이 너무 신기해요! 🥹 선생님께서 발음 하나하나 정말 다정하고 세밀하게 잡아주신 덕분에 일본어 공부가 취미가 되었습니다. 제 생애 최고의 선택이에요! ❤️✨",
                    rating: 5,
                    date: "2024-05"
                  },
                  {
                    ...
                    content: "동탄 주변 학원들 중에서 원어민 직강 퀄리티는 니혼톡이 진짜 압도적인 것 같습니다!! 🔥 매 수업마다 이해하기 힘든 뉘앙스 차이를 속 시원히 해결해주시니까 과외 받는 기분이에요. 덕분에 3급 합격 자신감이 200% 상승했습니다! 👍",
                    rating: 5,
                    date: "2024-05"
                  },
                  {
                    ...
                    content: "비즈니스 회화와 프레젠테이션 교정을 위해 등록했습니다. 업무용 고급 메일 표현과 일본 현지 직장 매너까지 디테일하게 피드백 받을 수 있어 큰 도움이 되었습니다. 넓고 여유로운 주차 공간이 지원되는 점도 직장인으로서 매우 만족스럽습니다.",
                    rating: 5,
                    date: "2024-04"
                  },
                  {
                    name: "박*희",
                    course: "초.중급 회화 수강생",
                    content: "센세랑 수다 떨듯이 대화하다 보면 1시간이 순식간에 지나가요! 😆 진짜 실생활에서 쓰이는 신조어나 정확한 현지 억양까지 재미있게 코칭해주셔서 매주 수업 시간만 목 빠지게 기다려집니다 🌸 센세 완전 고마워요~!",
                    rating: 5,
                    date: "2024-04"
                  }
                ].map((review, idx) => (
